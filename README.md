# Momentum Lock Helper

Momentum Lock is a Laravel package that lets you handle authorizations on the front-end.

You can find the full documentation [here](https://github.com/lepikhinb/momentum-lock).
